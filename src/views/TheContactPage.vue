...
<div class="container my-6 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-800">
    ...
    <div class="relative overflow-hidden bg-no-repeat bg-cover"
      style="background-position: 50%; background-image: url('https://img.freepik.com/premium-photo/contact-us-concept-business-woman-hand-pointing-icon-email-customer-service-call-center_2034-1944.jpg?w=2000'); height: 300px;">
    </div>
    <div class="container text-gray-800 px-4 md:px-12">
      <div class="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6"
        style="margin-top: -5px; background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
            ...
            <div class="flex flex-wrap">
              <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex items-start">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">techsupport@supprt.com</p>
              ...
              <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex items-start">
                  ...
                  <div class="grow ml-6">
                    <p class="font-bold mb-1">Promo, Sales, Refund</p>
                    <p class="text-gray-500">sales@promotions.com</p>
                    <p class="text-gray-500">+1 234-567-89</p>
                  </div>
                </div>
              </div>
              <div class="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex align-start">
                  ...
                  <div class="grow ml-6">
                    <p class="font-bold mb-1">Orders</p>
                    <p class="text-gray-500">orders@delivery.com</p>
                    <p class="text-gray-500">+1 234-567-89</p>
                  </div>
                </div>
              </div>
              <div class="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex align-start">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">bugs@errors.com</p>
                    <p class="text-gray-500">+1 234-567-89</p>
                  </div>
                </div>
              </div>
