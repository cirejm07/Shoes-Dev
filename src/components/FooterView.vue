<template>
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="">
        ...
        <p class="text-gray-600 mb-4">Basketball shoes</p>
        
        <p class="text-gray-600 mb-4">Running shoes</p>
        
        <p class="text-gray-600 mb-4">Walking shoes</p>
           
        <p class="text-gray-600">Training and Gym shoes</p>
  ...
  <div class="text-center p-6 bg-gray-200">
    ...
    <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> Shoes.Dev</a>
  </div>
</footer>
</template>
