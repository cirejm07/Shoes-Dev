<template>
  <div class="">
  <button type="button" class="border-none no-underline hover:underline text-base inline-block px-6 py-2.5 font-semibold text-xs leading-tight uppercase rounded focus:outline-none focus:ring-0 text-blue-600 active:shadow-lg transition duration-150 ease-in-out" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
    Signup
  </button>
  
  <button type="button" class="border-none no-underline mx-2 hover:underline text-base inline-block px-6 py-2.5 font-semibold text-xs leading-tight uppercase rounded focus:outline-none focus:ring-0 text-blue-600 active:shadow-lg transition duration-150 ease-in-out" data-bs-toggle="modal" data-bs-target="#exampleModalCenteredScrollable">
    Login
  </button>
</div>
